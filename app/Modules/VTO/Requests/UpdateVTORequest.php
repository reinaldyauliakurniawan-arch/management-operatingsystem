...
class UpdateVTORequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'three_year_revenue' => ['nullable', 'numeric'],
            'three_year_profit' => ['nullable', 'numeric'],
            'three_year_measurables' => ['nullable', 'integer'],
            'three_year_look' => ['nullable', 'array'],
            'one_year_date' => ['nullable', 'date'],
            'one_year_revenue' => ['nullable', 'numeric'],
            'one_year_profit' => ['nullable', 'numeric'],
            'one_year_measurables' => ['nullable', 'integer'],
