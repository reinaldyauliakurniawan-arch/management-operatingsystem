...
const navigation = [
    ...
    {
        name: "V/TO",
        href: route("vto.index"),
        icon: Target,
        current: route().current("vto.*"),
    },
    {
        name: "Rocks",
        href: route("rocks.index"),
        icon: Gem,
        current: route().current("rocks.*"),
    },
    {
        name: "Scorecard",
        href: route("scorecard.index"),
        icon: BarChart3,
        current: route().current("scorecard.*"),
    },
    {
        name: "L10 Meetings",
        href: route("l10.index"),
        icon: Calendar,
        current: route().current("l10.*"),
    },
    {
        name: "IDS",
        href: route("ids.index"),
        icon: AlertCircle,
        current: route().current("ids.*"),
    },
    {
        name: "To-Do List",
        href: route("todos.index"),
        icon: CheckSquare,
        current: route().current("todos.*"),
    },
    {
        name: "Teams",
    ...
    },
    {
        ...
        icon: Users,
        current: route().current("accountability.*"),
    },
    {
        name: "People Analyzer",
        href: route("people.index"),
        icon: UserCheck,
        current: route().current("people.*"),
    },
];
