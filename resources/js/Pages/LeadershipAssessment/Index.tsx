...
export default function LeadershipAssessmentIndex({
    ...
    const submitCycle = (e: React.FormEvent) => {
        e.preventDefault();
        cycleForm.post(route("leadership.cycles.store"), {
            onSuccess: () => {
                setCycleOpen(false);
                cycleForm.reset();
            },
    ...
    const submitAssign = (e: React.FormEvent) => {
        e.preventDefault();
        assignForm.post(route("leadership.assignments.store"), {
            onSuccess: () => {
                setAssignOpen(false);
                assignForm.reset();
            },
    ...
    const closeCycle = (id: number) =>
        router.patch(
            route("leadership.cycles.close", id),
            {},
            { preserveScroll: true },
        );

    const destroyCycle = (id: number) =>
        router.delete(route("leadership.cycles.destroy", id), {
            preserveScroll: true,
