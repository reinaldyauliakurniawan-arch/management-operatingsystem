            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
                    <div className="flex justify-end">
                        ...
                        >
                            <DialogTrigger
                                render={<Button>Evaluate Team Member</Button>}
                            />
                            <DialogContent className="max-w-2xl">
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        <label className="block text-sm font-medium border-b pb-1">
                                            Core Values
                                        </label>
                                        {coreValues.map(
                                            (cv: string, idx: number) => (
                                                <div
                                                    key={idx}
                            ...
                            <TableBody>
                                {evaluations.data.map((evalItem: any) => (
                                    <TableRow key={evalItem.id}>
                                        ...
                                        <TableCell className="text-center bg-muted/20 uppercase">
                                            {evalItem.gets_it || "-"}
                                        </TableCell>
                                        <TableCell className="text-center bg-muted/20 uppercase">
                                            {evalItem.wants_it || "-"}
